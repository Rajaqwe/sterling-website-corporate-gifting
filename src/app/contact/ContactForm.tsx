...
export function ContactForm() {
  ...
  return (
    <div className="min-h-screen bg-secondary/20">
      ...
      <MarketingHero 
        title="Contact Us"
        subtitle="Have questions about our corporate gifting solutions? Our dedicated team is ready to assist you with customized proposals, bulk orders, and general inquiries."
      />

      {/* Main Content */}
      <section className="container mx-auto px-4 sm:px-6 lg:px-8 pt-28 pb-16 max-w-6xl -mt-8 relative z-10">
                ...
                <form action={handleSubmit} className="space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                      ...
                      <Input id="firstName" name="firstName" placeholder="Enter your first name" required className="h-12 focus-visible:ring-accent" />
                    </div>
                    <div className="space-y-2">
                      <Label htmlFor="lastName">Last Name</Label>
                      <Input id="lastName" name="lastName" placeholder="Enter your last name" className="h-12 focus-visible:ring-accent" />
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                      ...
                      <Input id="email" name="email" type="email" placeholder="example@gmail.com" required className="h-12 focus-visible:ring-accent" />
                    </div>
                    <div className="space-y-2">
                      <Label htmlFor="phone">Phone Number</Label>
                      <Input id="phone" name="phone" type="tel" placeholder="+91 98765 43210" className="h-12 focus-visible:ring-accent" />
                    </div>
                  </div>

                  <div className="space-y-2">
                    <Label htmlFor="company">Company Name</Label>
                    <Input id="company" name="company" placeholder="Your organization name" className="h-12 focus-visible:ring-accent" />
                  </div>
