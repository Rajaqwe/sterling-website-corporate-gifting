        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
            <div className="p-6 rounded-xl bg-background shadow-sm">
              <div className="text-2xl font-serif font-bold text-primary mb-1">Audience</div>
              <div className="text-sm text-muted-foreground">Attendees, VIPs, partners, or speakers</div>
            </div>
            <div className="p-6 rounded-xl bg-background shadow-sm">
              <div className="text-2xl font-serif font-bold text-primary mb-1">Format</div>
              <div className="text-sm text-muted-foreground">Conference, launch, offsite, or award moment</div>
            </div>
            <div className="p-6 rounded-xl bg-background shadow-sm">
              <div className="text-2xl font-serif font-bold text-primary mb-1">Brief</div>
              <div className="text-sm text-muted-foreground">Quantity, branding, budget, and delivery needs</div>
            </div>
          </div>
        </div>
      </section>
