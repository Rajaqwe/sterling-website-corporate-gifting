...
const footerLinks = {
  about: [
    { name: "About Sterling", href: "/about" },
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 mb-16">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex items-center gap-3">
              ...
              <SocialIcon href="https://instagram.com/sterlinggifting" label="Instagram">
              ...
              <SocialIcon href="https://twitter.com/sterlinggifting" label="Twitter / X">
          ...
          <div>
            <h3 className="font-semibold text-lg mb-6 tracking-tight">Support</h3>
            <ul className="space-y-4">
